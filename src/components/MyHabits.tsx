    ...
    <div className="w-full min-h-screen">
      <div className="container mx-auto px-4 py-6 max-w-6xl">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
          <div>
            <h1 className="text-neutral-900 mb-2">Mis Hábitos</h1>
            <p className="text-neutral-600">
              Gestiona tus hábitos y monitorea tu progreso semanal
            </p>
          </div>
          <Button onClick={onCreateHabit} className="btn-primary gap-2 w-full sm:w-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 mb-6">
          <Card className="card-stat-small">
            <CardContent className="p-3 sm:p-4">
              <div className="space-y-1">
                <p className="text-neutral-600 text-xs sm:text-sm">Total de hábitos</p>
                <p className="text-neutral-900 truncate">{habits.length}</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="card-stat-small">
            <CardContent className="p-3 sm:p-4">
              <div className="space-y-1">
                <p className="text-neutral-600 text-xs sm:text-sm">Activos hoy</p>
          ...
          <Card className="card-stat-small">
            <CardContent className="p-3 sm:p-4">
              <div className="space-y-1">
                <p className="text-neutral-600 text-xs sm:text-sm">Progreso semanal</p>
                <p className="text-neutral-900 truncate">
          ...
          <Card className="card-stat-small">
            <CardContent className="p-3 sm:p-4">
              <div className="space-y-1">
                <p className="text-neutral-600 text-xs sm:text-sm">Racha más larga</p>
                <p className="text-neutral-900 truncate">
                  {longestStreak} días
                </p>
              </div>
        ...
        <div className="grid gap-4">
          {habits.map((habit) => {
            ...
            return (
              <Card key={habit.id} className="card-habit hover:shadow-md transition-shadow">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start justify-between gap-3">
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-2 flex-wrap">
                          <h3 className="text-neutral-900 truncate">{habit.name}</h3>
                          <Badge variant="secondary" className="badge-category text-xs flex-shrink-0">
                            {habit.category}
                          </Badge>
                        </div>
                        <p className="text-neutral-600 text-sm line-clamp-2">{habit.description}</p>
                      </div>
                      ...
                      <div className="flex items-center gap-1 sm:gap-2 flex-shrink-0">
                        <Button
                          ...
                          variant="ghost"
                          size="sm"
                          className="btn-icon-edit h-8 w-8 p-0"
                        >
                        ...
                        <Button
                          ...
                          variant="ghost"
                          size="sm"
                          className="btn-icon-delete text-red-600 hover:text-red-700 hover:bg-red-50 h-8 w-8 p-0"
                        >
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <span className={`flex-shrink-0 ml-2 ${isOnTrack ? 'text-green-600' : 'text-orange-600'}`}>
        ...
        {/* Empty State */}
        {habits.length === 0 && (
          <Card className="card-empty-state border-2 border-dashed">
            <CardContent className="p-8 sm:p-12 text-center space-y-4">
              <div className="w-16 h-16 rounded-full bg-blue-100 flex items-center justify-center mx-auto">
                <Target className="w-8 h-8 text-blue-600" />
              </div>
              <div>
                <h3 className="text-neutral-900 mb-2">No tienes hábitos aún</h3>
                <p className="text-neutral-600 mb-6">
                  Crea tu primer hábito para comenzar tu viaje de mejora personal
                </p>
                <Button onClick={onCreateHabit} className="btn-primary gap-2">
                  <Plus className="w-4 h-4" />
