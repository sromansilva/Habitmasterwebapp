          ...
          {navItems.map((item) => {
            ...
            return (
              <Button
                ...
                className={`w-full justify-start gap-3 nav-item ${
                  isActive ? 'bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 hover:bg-blue-100 dark:hover:bg-blue-900/50' : 'text-neutral-600 dark:text-neutral-300 dark:hover:bg-slate-700'
                }`}
              >
          ...
          {navItems.slice(0, 5).map((item) => {
            ...
            return (
              <Button
                ...
                variant="ghost"
                size="sm"
                className={`flex flex-col items-center gap-1 h-auto py-2 px-2 nav-item-mobile flex-1 max-w-[80px] ${
